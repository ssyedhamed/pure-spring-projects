...
<body>
<h1 class="container text-center mt-5">Update product details</h1>
  ...
  <div class="mb-3">
    ...
    <input type="hidden" class="form-control" name="id"  value="${product.id}" placeholder="id">
  </div>
 ...
 <div class="mb-3">
				...
				<textarea class="w-auto" rows="5" cols="35" id="desc" name="description" >${product.description}</textarea>
			</div>
  <div class="mb-3">
